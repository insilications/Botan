...
Source1  : https://botan.randombit.net/releases/Botan-2.18.2.tar.xz.asc
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637094078
...
cp %{_builddir}/Botan-2.18.2/license.txt %{buildroot}/usr/share/package-licenses/Botan/a5006686eab9488f49c4064f52a7a98250a7ec19
%make_install
